/**
 * \file vcjson_value_create_from_false.c
 *
 * \brief Create the bool false \ref vcjson_value singleton instance.
 *
...
static vcjson_value VCJSON_VALUE_FALSE_SINGLETON_IMPL = {
    .hdr = { .release = &vcjson_value_singleton_resource_release },
    .alloc = NULL,
    .type = VCJSON_VALUE_TYPE_BOOL,
    .value = &VCJSON_BOOL_FALSE_IMPL
};

static vcjson_value* VCJSON_VALUE_FALSE_SINGLETON =
    &VCJSON_VALUE_FALSE_SINGLETON_IMPL;
    ...
    vcjson_value** value, RCPR_SYM(allocator)* /*alloc*/)
{
    ...
    *value = VCJSON_VALUE_FALSE_SINGLETON;
